...
4. Indien je vaker bent gesanctioneerd voor een bepaald delict, heeft een stafflid het recht jou hoger te sanctioneren. 
5. Indien iets niet vermeld staat in de APV, behoud een stafflid het recht jou alsnog te sanctioneren, dit gebeurd altijd in overleg met meerdere staffleden. 
6. Het kan voorkomen dat staffleden een zogenoemde 'safeban' uitdelen, omdat er zaken onderzocht moeten worden. 
7. Indien je een bepaald feit meerdere keren pleegt, wordt de stafmaat steeds hoger. 
...
1. Het bewust misbruiken van een bug, exploit of onbedoelde game mechanic om voordeel te behalen voor jezelf of een ander is verboden.
    * Misbruik maken van bugs die niet gemeldt worden bij ons Developmentteam
...
1. Het is niet toegestaan een onrealistische rijstijl aan te nemen. Voorbeelden hiervan zijn:
    * Met een sport auto door de bergen heen rijden
    * Gebruik maken van hoge jumps of ramps, dit mag ook niet met een motor

2. In "Voertuigklasses" staan vermeld welke voertuigen off-road mogen rijden. 
...
* Rijd je boven de 30 km/h hoef je niet uit te stappen als daar om wordt gevraagd; 
...
### Artikel 12 - Accounts 
1. Het is niet toegestaan om gebruik te maken van alternatieve accounts te creëren. 
...
. Enkele voorbeelden hiervan zijn maar niet beperkt tot:
    ...
    * Een nieuw account aanmaken om het startersbijdrage over te schrijven naar je lopende account.
...
2. Enkele voorbeelden hiervan zijn:
    * Iemand bewust doodrijden als je aan het spookrijden bent, of op het voetpad.
    * Op iemand bewust inrijden.
    * Ook als je iemand niet volledig doodrijd maar wel bewust aanrijd telt dit als VDM.
...
4. Het is niet toegestaan om donatievoertuigen te verkopen voor ingame-valuta. 
...
2. Indien je een overval pleegt en de politie is gearriveerd mag je de politie niet vermoorden zonder goede reden. 
3. Indien de politie geen duidelijke afzetting heeft geplaatst, mag jouw overval gecounterd worden. 
